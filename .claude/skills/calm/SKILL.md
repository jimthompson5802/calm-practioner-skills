...
2. Read these tool prompt files to understand current CALM guidance:
    - `.claude/skills/calm/calm-prompts/architecture-creation.md`
    - `.claude/skills/calm/calm-prompts/calm-cli-instructions.md`
    - `.claude/skills/calm/calm-prompts/node-creation.md`
    - `.claude/skills/calm/calm-prompts/relationship-creation.md`
    - `.claude/skills/calm/calm-prompts/interface-creation.md`
    - `.claude/skills/calm/calm-prompts/metadata-creation.md`
    - `.claude/skills/calm/calm-prompts/control-creation.md`
    - `.claude/skills/calm/calm-prompts/flow-creation.md`
    - `.claude/skills/calm/calm-prompts/pattern-creation.md`
    - `.claude/skills/calm/calm-prompts/documentation-creation.md`
    - `.claude/skills/calm/calm-prompts/standards-creation.md`
    - `.claude/skills/calm/calm-prompts/moment-creation.md`
    - `.claude/skills/calm/calm-prompts/timeline-creation.md`
    - `.claude/skills/calm/calm-prompts/decorator-creation.md`
